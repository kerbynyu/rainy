Shader "examples/week 8/normal mapping"
{
    Properties 
    {
        ...
        [NoScaleOffset] _normalMap ("normal map", 2D) = "bump" {} // bump is for normal map
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3x3 tangentTwoWorld = float3x3 (
                    i.tangent.x, i.bitangent.x, i.normal.x,
                    i.tangent.y, i.bitangent.y, i.normal.y,
                    i.tangent.z, i.bitangent.z, i.normal.z
                );

                float3 normal = mul(tangentTwoWorld, tangentSpaceNormal); 
                //color = normal;
...
/* only the G & the A channels are holding information for the normal map. And it
gets reconstructed. But you can use UnpackNoral to make it look how it looks. 
*/
