Shader "examples/week 8/transparency"
{
    ...
    SubShader
    {
        // tags here set the render queue to happen with transparencies (the render queue, 0  = first ) transparent should be rendered last 
        ...
        // this line prevents this object from writing to the depth buffer (getting rid of stuff behind is = occlusion culling)
